  ...
  render() {
    return (
      <div className="m-l-r-12-5">
        ...
        <div className="sidebar col-3 m-top-3 ">
          <Header selected="0" />
          <img
            src="/img/self.png"
            alt=""
        ...
        <div className="col-8 m-top-4 m-l-37-5 snap">
          <Link to="/airbnb" className="m-top-5 a-no-line case-airbnb">
            <div className="p-absolute col-8 case case-airbnb z-99">
              <img
                src="/img/logo-airbnb.png"
                className="w-5 m-top-5 p-absolute m-left-3 logo-hover"
              />
              <img
                src="/img/button-airbnb.png"
                className="m-t-3-5 p-absolute w-7-5 cta-hover"
              />
              <div className="m-l-12-5 m-top-5 p-absolute">
              ...
              <img
                ...
                className="col-8 m-t-7-5 img-hover"
              />
            </div>
            <img
              src="/img/bg-airbnb.png"
              className="w-150 m-l-12-5 bg-hover m-h-400"
            />
          </Link>
            ...
            <div className="case m-top-10 case-non">
              <div className="p-absolute col-8 z-99">
                <img
                  ...
                  className="w-5 m-top-5 p-absolute m-left-3 "
                />

                <div className="m-left-10 m-top-5 p-absolute">
                ...
                <img
                  ...
                  className="col-8 m-t-7-5 m-l-8-33"
                />
              </div>
            ...
            <div className="case m-top-10 case-non">
              <div className="p-absolute col-8 z-99">
                ...
                <img
                  ...
                  className="col-2 m-top-15 m-l-8-33 v-align-top"
                />
                <img
                  src="/img/wf-visualdesign.png"
                  className="col-6 v-align-top m-top-15"
                />
              </div>
              <img
